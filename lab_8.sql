...
SELECT REGION,YEAR, MIN(SALES_AMOUNT) AS TOTAL_AMOUNT
FROM SALES_DATA
...
SELECT PRODUCT, AVG(SALES_AMOUNT) AS TOTAL_SALES_AMOUNT 
FROM SALES_DATA
GROUP BY PRODUCT
...
SELECT YEAR, MAX(SALES_AMOUNT) AS MAX_SALES_AMOUNT
FROM SALES_DATA
GROUP BY YEAR
...
SELECT YEAR,MIN(SALES_AMOUNT) AS MIN_SALES_AMOUNT
FROM SALES_DATA
GROUP BY YEAR
...
SELECT REGION,YEAR,COUNT(REGION) AS TOTAL_REGION 
FROM SALES_DATA
GROUP BY REGION,YEAR
...
SELECT REGION,MAX(SALES_AMOUNT) AS TOTAL_AMOUNT
FROM SALES_DATA
GROUP BY REGION
...
SELECT REGION,PRODUCT,COUNT(DISTINCT PRODUCT)
FROM SALES_DATA
