...
SELECT POWER(3,2) AS _3_base_to_2,POWER(4,3) AS _4_base_to_3;
...
SELECT ROUND(157.732,2) AS ROUNT_UPTO_2_DIGITS,
	   ...
	   ROUND(157.732,-1) AS ROUNT_UPTO_2_DIGITS,
...
SELECT LEN('NULL') AS LENGTH_OF_NULL , LEN('HELLO') AS LENGTH_OF_HELLO , LEN('') AS LENGTH_OF_BLANK

--2.Display your name in lower & upper case.

SELECT LOWER('DEEP') AS LOWER_CASE , UPPER('DEEP') AS UPPER_CASE;

--3.Display first three characters of your name.

SELECT SUBSTRING('DEEP' , 1 ,3);
SELECT LEFT('DEEP',3)

--4.Display 3rd to 10th character of your name.

SELECT SUBSTRING('VAMJADEEPS' ,3,8);
...
SELECT SPACE(10) + 'DEEP';

--14.Combine two strings using + sign as well as CONCAT ().

SELECT 'DEEP' + 'VAMJA';
SELECT CONCAT('DEEP' , 'VAMJA');
...
SELECT FORMAT(CAST('1994-5-5' AS datetime), 'MMMM d yyyy hh:mm') AS Formatted_Date;
Select CONVERT(varchar,GETDATE(),100)

--4.Display the current date in a format that appears as 03 Jan 1995.

SELECT FORMAT(CAST('1995-1-3' AS datetime), ' d MMMM yyyy') AS Formatted_Date;

--5.Display the current date in a format that appears as Jan 04, 96.

SELECT FORMAT(CAST('1996-1-4' AS datetime), 'MMMM dd yy') AS Formatted_Date;
...
SELECT DATEADD(MONTH , -2 , GETDATE()) AS TWO_MONTH_SUBTRACTED;

--12.Extract month from current date using datename () and datepart () function.

SELECT DATENAME(MONTH , GETDATE()) AS MONTH_;
SELECT DATEPART(MONTH , GETDATE()) AS MONTH_;
...
SELECT DATEDIFF(YEAR , '2004-11-22' , GETDATE());
...
SELECT DATEDIFF(YEAR , '2004-11-22' , GETDATE());
SELECT DATEDIFF(MONTH , '2004-11-22' , GETDATE());
